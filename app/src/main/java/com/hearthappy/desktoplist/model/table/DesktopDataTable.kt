...
class DesktopDataTable(@PrimaryKey(autoGenerate = true) val id: Long = 0, val title: String, val url: String, val pageNumber: Int, val pageAdapterPosition: Int, val orientation: Int) : IBindDataModel {
